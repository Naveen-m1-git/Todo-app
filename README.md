...
You can also refer to the [ESLint documentation](https://eslint.org/docs/latest/user-guide/configuring/) for more information on how to customize your ESLint configuration.